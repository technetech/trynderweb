  ...
  return (
    <section className="py-24 lg:py-36 bg-transparent relative overflow-hidden border-t border-zinc-200">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        ...
        {/* Glow Container */}
        <div className="relative bg-[#111111] border-2 border-[#FFBF00] p-8 sm:p-16 shadow-[0_0_60px_rgba(255,255,0,0.18)] overflow-hidden">
          
          <div className="inline-block bg-[#FFBF00] text-black text-[10px] font-black uppercase px-3 py-1 tracking-widest mb-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              className="group w-full sm:w-auto inline-flex items-center justify-center gap-3 px-10 py-5 text-base font-black uppercase tracking-tighter text-black bg-[#FFBF00] hover:scale-105 transition-all shadow-[0_0_40px_rgba(255,255,0,0.4)] cursor-pointer"
            >
