  ...
  return (
    <footer className="bg-black border-t border-zinc-800 text-zinc-400 text-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-6 border-b border-zinc-800 flex flex-wrap items-center justify-between gap-6">
          <div className="flex items-center gap-8">
            <div className="flex flex-col">
              <span className="text-[9px] font-bold text-zinc-500 uppercase tracking-widest">Nivel actual</span>
              <span className="text-xs font-black text-white uppercase tracking-wider">AVANZADO</span>
            </div>
            <div className="flex flex-col">
              <span className="text-[9px] font-bold text-zinc-500 uppercase tracking-widest">Escenarios</span>
              <span className="text-xs font-black text-white uppercase tracking-wider">500+ DISPONIBLES</span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 py-12 border-b border-zinc-800">
          
          {/* Col 1: Brand */}
          <div className="md:col-span-2 space-y-4">
            <div className="flex items-center gap-2.5">
              <div className="w-7 h-7 bg-[#FFFF00] rounded-full flex items-center justify-center">
            ...
            <p className="text-zinc-400 text-xs sm:text-sm max-w-md leading-relaxed font-medium">
        ...
        <div className="py-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-500">
          ...
          <button
            onClick={scrollToTop}
            className="flex items-center gap-1.5 text-zinc-300 hover:text-[#FFFF00] transition-colors px-3 py-1.5 bg-zinc-900 border border-zinc-800 text-xs font-black uppercase tracking-wider cursor-pointer"
          >
