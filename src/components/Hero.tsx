      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-0">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center px-4 sm:px-8 lg:pl-12 lg:pr-10 py-12 sm:py-16 lg:py-24 text-left">
          ...
          <motion.h1
            ...
            className="text-5xl sm:text-7xl lg:text-[88px] leading-[0.88] font-black tracking-tighter uppercase mb-6 italic text-white"
          >
            Domina <br />
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl text-zinc-400 max-w-lg mb-8 font-medium leading-tight"
          >
          ...
          >
            ...
            <button
              ...
              className="border-2 border-white px-6 py-4 text-xs font-black uppercase tracking-widest text-white hover:bg-white hover:text-black transition-all cursor-pointer flex items-center gap-2"
            >
          ...
          <div className="flex items-center gap-5 pt-6 border-t border-zinc-800/80">
            <div className="flex -space-x-3">
              <div className="w-10 h-10 rounded-full border-2 border-black bg-zinc-800 flex items-center justify-center text-[10px] font-black text-[#FFFF00]">
                +10k
              </div>
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest text-zinc-400 leading-tight">
              Usuarios activos <br />
              <strong className="text-white font-black">esta semana</strong>
            </span>
          </div>
        ...
        <div className="lg:col-span-5 relative bg-[#111111] border-t lg:border-t-0 lg:border-l border-zinc-800 flex flex-col items-center justify-center p-6 sm:p-12 overflow-hidden min-h-[620px]">
          ...
          <div className="absolute top-6 right-6 sm:top-8 sm:right-8 text-right z-20">
            ...
            <div className="text-[9px] sm:text-[10px] font-bold uppercase text-zinc-400 tracking-tighter leading-tight">
          ...
          <div className="w-[310px] sm:w-[340px] bg-black border-[6px] border-zinc-800 rounded-[38px] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.9),0_0_35px_rgba(255,255,0,0.15)] relative overflow-hidden flex flex-col z-10">
            
            {/* Phone Top Header */}
            <div className="bg-zinc-900 p-4 border-b border-zinc-800 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-[#FFFF00] to-white flex items-center justify-center text-black font-black text-xs">
                  {profile.name[0]}
                </div>
                <div>
            ...
            {/* Profile Card View */}
            <div className="relative aspect-[3/3.8] bg-zinc-950 overflow-hidden">
                  ...
                  {swipeFeedback && (
                    <div className="absolute inset-0 flex items-center justify-center bg-black/60 backdrop-blur-xs z-20">
                      {swipeFeedback === 'like' ? (
                        ...
                        <div className="bg-zinc-900 border-2 border-red-500 text-red-400 px-6 py-2.5 font-black text-xl uppercase tracking-tighter flex items-center gap-2">
                          <X className="w-5 h-5" />
                          <span>SIGUIENTE</span>
                        </div>
                      )}
              ...
              <div className="absolute top-3 left-3 z-10">
                <div className="px-2 py-0.5 bg-black/80 text-[#FFFF00] text-[10px] font-black uppercase flex items-center gap-1 border border-zinc-800">
            ...
            <div className="p-3 bg-zinc-900 border-t border-zinc-800 flex items-center justify-between gap-3">
              <button
                ...
                className="flex-1 py-2.5 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 font-black text-xs uppercase tracking-wider flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
              >
                <X className="w-4 h-4" />
                <span>Pasar</span>
              </button>
