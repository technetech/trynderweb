...
export const FeaturesSection: React.FC<FeaturesSectionProps> = ({ onOpenAppClick }) => {
  return (
    <section id="beneficios" className="py-20 lg:py-32 bg-black relative border-t border-zinc-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {FEATURES.map((feat, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-[#111111] border-2 border-zinc-800 hover:border-[#FFFF00] p-8 transition-colors flex flex-col justify-between group"
              >
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <div className="w-12 h-12 bg-black border border-zinc-700 group-hover:border-[#FFFF00] flex items-center justify-center text-[#FFFF00] transition-colors">
                      <Icon className="w-6 h-6" />
                    </div>
                    <span className="px-2.5 py-1 text-[10px] font-black uppercase tracking-wider bg-black text-[#FFFF00] border border-zinc-800 font-mono-tag">
                      {feat.metric}
                    </span>
                  </div>
                ...
                <div className="pt-6 mt-6 border-t border-zinc-800 flex items-center justify-between text-xs font-black uppercase text-zinc-400 group-hover:text-white transition-colors">
        ...
        <div className="bg-[#111111] border-2 border-zinc-800 p-6 sm:p-10 relative">
          <div className="text-left max-w-2xl mb-10 space-y-2">
            <div className="inline-block bg-white text-black text-[9px] font-black uppercase px-2 py-0.5 tracking-wider">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Sin Trynder */}
            <div className="bg-black border border-red-900/50 p-6 space-y-4">
            ...
            {/* Con Trynder */}
            <div className="bg-black border-2 border-[#FFFF00] p-6 space-y-4 shadow-[0_0_20px_rgba(255,255,0,0.15)]">
