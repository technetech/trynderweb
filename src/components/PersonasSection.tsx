...
export const PersonasSection: React.FC<PersonasSectionProps> = ({ onOpenAppClick }) => {
  return (
    <section id="perfiles" className="py-20 lg:py-32 bg-black relative border-t border-zinc-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {PERSONAS.map((persona, index) => (
            <motion.div
              ...
              className="group bg-[#111111] border-2 border-zinc-800 hover:border-[#FFFF00] overflow-hidden flex flex-col transition-all duration-300 hover:shadow-[0_0_25px_rgba(255,255,0,0.15)]"
            >
              {/* Card Image Header */}
              <div className="relative aspect-[4/5] overflow-hidden bg-black">
                ...
                <div className="absolute top-3 right-3">
                  <span className="px-2 py-0.5 text-[10px] font-black bg-black text-[#FFFF00] border border-zinc-800 flex items-center gap-1">
              ...
              <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-1.5 pt-1">
                    {persona.badges.map((b, i) => (
                      <span
                        key={i}
                        className="px-2 py-0.5 text-[9px] font-bold uppercase bg-black text-zinc-300 border border-zinc-800"
                      >
                        {b}
                      </span>
                    ))}
                ...
                <div className="bg-black border border-zinc-800 p-3 space-y-1">
                  <div className="text-[9px] uppercase font-black tracking-widest text-zinc-500">
                    Banter de prueba:
                  </div>
                  <p className="text-xs text-zinc-300 italic line-clamp-2 font-medium">
        ...
        <div className="mt-12 p-6 bg-[#111111] border-2 border-zinc-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-black border border-zinc-700 flex items-center justify-center text-[#FFFF00] shrink-0">
          ...
          <button
            ...
            onClick={onOpenAppClick}
            className="shrink-0 px-6 py-3 text-xs font-black uppercase tracking-wider text-white bg-black hover:bg-white hover:text-black border border-zinc-600 transition-colors flex items-center gap-2 cursor-pointer"
          >
