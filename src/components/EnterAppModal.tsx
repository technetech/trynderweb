    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <button
            onClick={onClose}
            className="absolute top-5 right-5 p-1.5 text-zinc-400 hover:text-white hover:bg-black transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
          ...
          {!submitted ? (
            <div className="space-y-6">
              ...
              <button
                ...
                className="w-full py-3.5 px-4 bg-black border border-zinc-700 hover:border-[#FFFF00] text-zinc-200 hover:text-white font-black text-xs uppercase tracking-wider flex items-center justify-between transition-colors"
              >
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                <input
                  ...
                  className="w-full bg-black border border-zinc-700 focus:border-[#FFFF00] px-4 py-3.5 text-xs sm:text-sm text-white placeholder-zinc-500 focus:outline-none transition-colors"
                />
            ...
            <div className="text-center py-6 space-y-4">
              ...
              <p className="text-xs sm:text-sm text-zinc-300 max-w-sm mx-auto leading-relaxed font-medium">
