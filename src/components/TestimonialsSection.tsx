          ...
          {TESTIMONIALS.map((t, idx) => (
            ...
            >
              <div className="space-y-4">
                ...
                {/* Headline */}
                <h3 className="text-base sm:text-lg font-black uppercase text-black font-display tracking-tight">
                  "{t.headline}"
                </h3>
              ...
              <div className="pt-6 mt-6 border-t border-zinc-200 space-y-4">
                {/* Metric Before / After */}
                <div className="bg-white p-3 border border-zinc-200 flex items-center justify-between text-xs">
                  <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <h4 className="text-xs font-black uppercase text-black">{t.name}, {t.age}</h4>
                    <span className="text-[11px] text-zinc-600 font-mono-tag">{t.city} • {t.handle}</span>
                  </div>
                </div>
              </div>
            </motion.div>
