...
export const TestimonialsSection: React.FC<TestimonialsSectionProps> = () => {
  return (
    <section id="testimonios" className="py-20 lg:py-32 bg-black relative border-t border-zinc-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {TESTIMONIALS.map((t, idx) => (
            <motion.div
              ...
              className="bg-[#111111] border-2 border-zinc-800 hover:border-[#FFFF00] p-6 sm:p-8 transition-colors flex flex-col justify-between"
            >
              ...
              <div className="pt-6 mt-6 border-t border-zinc-800 space-y-4">
                {/* Metric Before / After */}
                <div className="bg-black p-3 border border-zinc-800 flex items-center justify-between text-xs">
                  <div>
                    <span className="text-zinc-500 block text-[9px] uppercase font-black tracking-wider">Antes:</span>
                    <span className="text-red-400 font-mono-tag text-xs">{t.statBefore}</span>
                  </div>
                  <div className="w-[1px] h-6 bg-zinc-800" />
                  <div className="text-right">
                    <span className="text-zinc-500 block text-[9px] uppercase font-black tracking-wider">Con Trynder:</span>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-[11px] text-zinc-400 font-mono-tag">{t.city} • {t.handle}</span>
                  </div>
                </div>
              </div>
            </motion.div>
